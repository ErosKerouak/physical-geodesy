...
Dessa forma, o potencial gravitacional \( V \) é uma função \textit{harmônica} fora das massas e uma função \textit{superharmônica} dentro delas. Esse resultado é fundamental na geodésia física e na modelagem do campo de gravidade terrestre, sendo extensivamente utilizado na formulação de problemas de contorno e na determinação do campo externo da Terra por meio da teoria do potencial.
...
\begin{enumerate}
   ...
   Como \( T \) pode ser estimado por meio de medições gravimétricas e modelos do potencial normal, a equação permite calcular \( N \) e, assim, mapear a forma do geóide.
