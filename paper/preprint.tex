...
\newcommand{\Title}{Métodos Físicos em Geodésia}
\newcommand{\TitleShort}{CGEO7023}

\newcommand{\Year}{2025}
\newcommand{\SubmittedOn}{2025/04/28}
\newcommand{\PublishedOn}{2025/04/28}

\newcommand{\AuthorShort}{Pereira \textit{et al.}}
\newcommand{\Authors}{%
  Eros Kerouak Cordeiro Pereira\textsuperscript{1}
}
\newcommand{\Email}{contact-email@university.org}
\newcommand{\Corresponding}{%
  Corresponding author: Eros Kerouak Cordeiro Pereira <\href{mailto:\Email}{\Email}>
}
\newcommand{\Affiliations}{%
  \textsuperscript{1} Universidade Federal do Paraná, Brazil;

}

\newcommand{\Journal}{Geodesy, Geophysics, Geosystems}
